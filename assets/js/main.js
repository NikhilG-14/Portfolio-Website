...
const sendEmail = (e) => {
    ...
    emailjs
        .sendForm(
            "service_o4z64wf", // Your service ID
            "template_0h24vqz", // Your template ID
            contactForm,       // This should be the form element (not a string)
            "UcmKZHwgOCaTDbaAq" // Your public key
        )
        .then(() => {
            message.classList.remove("color-red");
